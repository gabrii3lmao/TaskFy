...
teamsRouter.post("/", requireAuth, validate(createTeamSchema), TeamsController.create);
teamsRouter.post("/:teamId/members", requireAuth, validate(addMemberSchema), TeamsController.addMember);
export { teamsRouter };
