...
describe("ProjectsService", () => {
    ...
    it("deve lançar um erro 400 se o supervisor NÃO for membro da equipe", async () => {
        ...
        db.where.mockResolvedValueOnce([]); // Retorna array vazio
        // EXECUÇÃO & VALIDAÇÃO
        // Esperamos que a chamada assíncrona rejeite com um erro específico
        await expect(ProjectsService.createProject(mockProjectData)).rejects.toThrow(new HttpException("O supervisor selecionado não é membro da equipe responsável.", 400));
